...
| [Release artifacts and CI](#release-artifacts-and-ci) | → [BUILDING.md](BUILDING.md) |
...
[BUILDING.md](BUILDING.md) covers the rest: what each `nix build` target
produces, why the site package is only built once, why the binaries carry no
runtime dependencies, and how a tag turns into a published release.
